...
const router = createRouter({
  ...
  routes: [
    ...
    { path: "/answers", name: "answer-history", component: () => import("@/views/AnswerHistoryView.vue"), meta: { requiresAuth: true, requiresUser: true } },
    { path: "/answers/:answerId", name: "answer-detail", component: () => import("@/views/AnswerDetailView.vue"), meta: { requiresAuth: true, requiresUser: true } },
    {
      path: "/admin",
