...
public record QuestionSearchRequest(
        ...
        @Pattern(
                regexp = "ADMIN|SYSTEM_FOLLOW_UP",
                message = "origin은 ADMIN, SYSTEM_FOLLOW_UP 중 하나여야 합니다."
        )
        String origin,
    ...
    public QuestionStatus statusValue() {
        return status == null ? null : QuestionStatus.valueOf(status);
    }
    ...
    public QuestionOrigin originValue() {
