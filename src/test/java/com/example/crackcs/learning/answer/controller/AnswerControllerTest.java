...
class AnswerControllerTest {
    ...
    void findsAnswerHistoryWithDefaultPaging() throws Exception {
        AnswerResult response = evaluatingAnswer(31L, 7L, "문제 본문", "답변");
    ...
    void findsAnswerById() throws Exception {
        AnswerResult response = evaluatedAnswer();
    ...
    void findsEvaluation() throws Exception {
        AnswerEvaluationResult response = evaluatedResponse();
    ...
    void returnsFailedEvaluation() throws Exception {
        AnswerEvaluationResult response = new AnswerEvaluationResult(
    ...
    private AnswerResult evaluatingAnswer(Long id, Long questionId, String questionContent, String content) {
        AnswerEvaluationResult evaluation = new AnswerEvaluationResult(
    ...
    private AnswerResult evaluatedAnswer() {
        return new AnswerResult(
                31L, 7L, "문제 본문", "답변 원문",
                LocalDateTime.of(2026, 9, 7, 10, 30), evaluatedResponse(), 51L);
    }

    private AnswerEvaluationResult evaluatedResponse() {
        return new AnswerEvaluationResult(
                ...
                "핵심 개념을 보완하세요.",
                null,
                List.of(new AnswerEvaluationResult.ConceptResult(
